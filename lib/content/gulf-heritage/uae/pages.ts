...
const ROASTER_DEFAULTS: Pick<GulfHeritagePageDefinition, "kind" | "relatedRecipeSlugs"> = {
  kind: "roaster",
  relatedRecipeSlugs: [],
};

const ARTICLE_DEFAULTS: Pick<GulfHeritagePageDefinition, "kind" | "relatedRecipeSlugs"> = {
  kind: "article",
  relatedRecipeSlugs: [],
};
